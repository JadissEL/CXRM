...
import { Heart, MapPin, Star, Clock, Phone, Globe, Instagram, MessageCircle, Calendar, Verified, Smartphone } from 'lucide-react';
            ...
            <div className="flex items-center gap-1">
              ...
              <Button
                ...
                onClick={(e) => {
                  e.preventDefault();
                  e.stopPropagation();
                  console.log('Booking button clicked for barber:', barber.id);
                  // Navigate to booking page with proper Next.js routing
                  window.location.href = `/booking?barberId=${barber.id}`;
                }}
