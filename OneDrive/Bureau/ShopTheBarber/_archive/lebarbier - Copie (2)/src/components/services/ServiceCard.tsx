...
import { Star, Clock, DollarSign, MapPin, Heart, User, Verified, Play } from 'lucide-react';
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center justify-between">
                ...
                <Button 
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    console.log('Service booking button clicked (list view) for service:', service.id);
                    // Navigate to booking page with service and barber info
                    window.location.href = `/booking?barberId=${service.barber_id}&serviceId=${service.id}`;
                  }}
                >
      ...
      <div className="relative">
        ...
        <CardContent className="p-4">
          ...
          <Button 
            ...
            onClick={(e) => {
              e.stopPropagation();
              console.log('Service booking button clicked for service:', service.id);
              // Navigate to booking page with service and barber info
              window.location.href = `/booking?barberId=${service.barber_id}&serviceId=${service.id}`;
            }}
          >
