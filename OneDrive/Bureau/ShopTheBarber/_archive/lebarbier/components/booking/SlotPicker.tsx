...
import { Clock, Calendar, AlertCircle, CheckCircle, Star as RefreshCw } from 'lucide-react';
...
export default function SlotPicker({
  ...
  useEffect(() => {
    ...
    const appointmentSubscription = supabase
      .channel('slot-picker-appointments')
      .on(
        'postgres_changes',
        {
          event: '*',
    ...
    const reservationSubscription = supabase
      .channel('slot-picker-reservations')
      .on(
        'postgres_changes',
        {
          event: '*',
