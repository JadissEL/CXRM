import { useBarberPromotionManagement } from './useBarberPromotionManagement';
...
export default function BarberPromotionManagement() {
    const { promotions, stats } = useBarberPromotionManagement();
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-8">
                    <Card className="rounded-2xl border-none shadow-soft bg-surface-light dark:bg-surface-dark">
                        <CardContent className="p-6">
                            ...
                            <p className="text-4xl font-display font-bold text-charcoal dark:text-white">{stats.activeCount}</p>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="rounded-2xl border-none shadow-soft bg-surface-light dark:bg-surface-dark">
                        <CardContent className="p-6">
                            ...
                            <p className="text-4xl font-display font-bold text-charcoal dark:text-white">{stats.totalUsed}</p>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="rounded-2xl border-none shadow-soft bg-surface-light dark:bg-surface-dark">
                        <CardContent className="p-6">
                            ...
                            <p className="text-4xl font-display font-bold text-charcoal dark:text-white">{stats.conversionRate}%</p>
                        </CardContent>
                    </Card>
                </div>
