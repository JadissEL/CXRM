import { useBarberClientList } from './useBarberClientList';
...
export default function BarberClientList() {
    const { clients, stats } = useBarberClientList();
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-8">
                    <Card className="rounded-2xl border-none shadow-soft bg-surface-light dark:bg-surface-dark">
                        <CardContent className="p-6">
                            ...
                            <p className="text-4xl font-display font-bold text-charcoal dark:text-white">{stats.total}</p>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="rounded-2xl border-none shadow-soft bg-surface-light dark:bg-surface-dark">
                        <CardContent className="p-6">
                            ...
                            <p className="text-4xl font-display font-bold text-charcoal dark:text-white">{stats.totalVisits}</p>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="rounded-2xl border-none shadow-soft bg-surface-light dark:bg-surface-dark">
                        <CardContent className="p-6">
                            ...
                            <p className="text-4xl font-display font-bold text-charcoal dark:text-white">{stats.regularClients}</p>
                        </CardContent>
                    </Card>
                </div>
