...
export default function ClientWallet() {
    const { balance, transactions, stats } = useClientWallet();
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        <Card className="rounded-2xl border-none shadow-soft bg-surface-light dark:bg-surface-dark">
                            <CardContent className="p-6">
                                ...
                                <p className="text-2xl font-bold text-charcoal dark:text-white">{stats.received.toFixed(2)}€</p>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="rounded-2xl border-none shadow-soft bg-surface-light dark:bg-surface-dark">
                            <CardContent className="p-6">
                                ...
                                <p className="text-2xl font-bold text-charcoal dark:text-white">{stats.spent.toFixed(2)}€</p>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="rounded-2xl border-none shadow-soft bg-surface-light dark:bg-surface-dark">
                            <CardContent className="p-6">
                                ...
                                <p className="text-2xl font-bold text-charcoal dark:text-white">{stats.savings.toFixed(2)}€</p>
                            </CardContent>
                        </Card>
                    </div>
