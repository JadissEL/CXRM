import { useShopExpenseTracking } from './useShopExpenseTracking';
...
export default function ShopExpenseTracking() {
    const { expenses, categories, stats } = useShopExpenseTracking();
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-8">
                    <Card className="rounded-2xl border-none shadow-soft bg-gradient-to-br from-red-500 to-red-600 text-white">
                        <CardContent className="p-6">
                            ...
                            <p className="text-4xl font-display font-bold">{stats.totalExpenses}€</p>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="rounded-2xl border-none shadow-soft bg-surface-light dark:bg-surface-dark">
                        <CardContent className="p-6">
                            ...
                            <p className="text-4xl font-display font-bold text-charcoal dark:text-white">{stats.recurringExpenses}€</p>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="rounded-2xl border-none shadow-soft bg-surface-light dark:bg-surface-dark">
                        <CardContent className="p-6">
                            ...
                            <p className="text-4xl font-display font-bold text-charcoal dark:text-white">{stats.categoriesCount}</p>
                        </CardContent>
                    </Card>
                </div>
