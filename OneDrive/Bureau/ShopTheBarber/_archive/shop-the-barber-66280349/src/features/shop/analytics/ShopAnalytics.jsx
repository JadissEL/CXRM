...
export default function ShopAnalytics() {
    const { revenueData, serviceData, stats } = useShopAnalytics();

    const iconMap = { DollarSign, TrendingUp, TrendingDown, Calendar };
                                ...
                                <Card className="rounded-2xl border-none shadow-soft bg-surface-light dark:bg-surface-dark">
                                    <CardContent className="p-6">
                                        <div className="flex items-center justify-between mb-4">
                                            <Icon className={`w-10 h-10 ${stat.trend === 'up' ? 'text-emerald-600' : 'text-red-600'}`} />
