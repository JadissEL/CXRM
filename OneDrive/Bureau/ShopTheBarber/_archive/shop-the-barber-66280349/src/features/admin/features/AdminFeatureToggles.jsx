import { useAdminFeatureToggles } from './useAdminFeatureToggles';
...
export default function AdminFeatureToggles() {
    const { features, categoryConfig, stats, toggleFeature } = useAdminFeatureToggles();
        ...
        <div className="min-h-screen py-12 bg-background-light dark:bg-background-dark font-sans">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-8">
                    {[
                        { label: "Fonctionnalités Actives", value: stats.active, icon: Zap, color: "text-emerald-600" },
                        { label: "Fonctionnalités Désactivées", value: stats.inactive, icon: Shield, color: "text-slate-600" },
                        { label: "Total", value: stats.total, icon: ToggleLeft, color: "text-blue-600" }
                    ].map((stat, idx) => (
