import { useAdminContentManagement } from './useAdminContentManagement';
...
export default function AdminContentManagement() {
    const { content, statusColors, typeLabels, stats } = useAdminContentManagement();
        ...
        <div className="min-h-screen py-12 bg-background-light dark:bg-background-dark font-sans">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-8">
                    {[
                        { label: "Total Contenus", value: stats.total },
                        { label: "Publiés", value: stats.published },
                        { label: "Vues Totales", value: stats.totalViews.toLocaleString() }
                    ].map((stat, idx) => (
