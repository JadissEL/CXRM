...
export default function WishlistCollectionManager({ open, onOpenChange, collections, products }) {
  ...
  const createCollectionMutation = useMutation({
    mutationFn: async (collectionData) => {
      ...
      return await base44.entities.WishlistCollection.create({
        ...collectionData,
        user_id: user.id,
        product_ids: [],
  ...
  const updateCollectionMutation = useMutation({
    mutationFn: ({ id, data }) => base44.entities.WishlistCollection.update(id, data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['wishlist-collections'] });
  ...
  const deleteCollectionMutation = useMutation({
    mutationFn: (id) => base44.entities.WishlistCollection.delete(id),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['wishlist-collections'] });
    }
  });
