          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-3 gap-4 mb-8">
              ...
              <div className="relative">
                <span className="absolute left-4 top-1/2 -translate-y-1/2 text-moroccan-gold">
                  <Search className="h-5 w-5" />
                </span>
                <input
                  type="text"
                  placeholder="Rechercher un barbier..."
                  className="w-full pl-12 pr-4 py-3 rounded-full bg-white/80 dark:bg-moroccan-charcoal/80 border-2 border-moroccan-gold/20 text-moroccan-charcoal dark:text-moroccan-offwhite placeholder:text-moroccan-gold/60 focus:border-moroccan-gold focus:ring-2 focus:ring-moroccan-gold/30 shadow-sm hover:shadow-md transition-all duration-300"
                  value={searchTerm}
              ...
              {/* Location Filter */}
              <select
                className="w-full px-4 py-3 rounded-full bg-white/80 dark:bg-moroccan-charcoal/80 border-2 border-moroccan-gold/20 text-moroccan-charcoal dark:text-moroccan-offwhite focus:border-moroccan-gold focus:ring-2 focus:ring-moroccan-gold/30 shadow-sm hover:shadow-md transition-all duration-300"
